...
export default function CreateListing() {
  ...
  return (
    ...
    <h1 className='text-4xl font-semibold text-center my-8 text-gray-900'>
      Create a Listing
    </h1>
      ...
      {formData.imageUrls.length > 0 && (
        <div className='flex flex-wrap gap-4 mt-4'>
          {formData.imageUrls.map((url, index) => (
            <div key={url} className='flex justify-between p-2 border-2 border-gray-300 rounded items-center'>
              <img
                src={url}
                alt='listing preview'
